...
public class Thread extends Post
{
	...
	public Thread(User author, String topic, String content, Rating rating, LocalDateTime timeOfCreation)
	{
        ...
        public Thread(int id, User author, String topic, String content, Rating rating, LocalDateTime timeOfCreation)
	{
		super(id, author, content, rating, timeOfCreation);
		this.topic = topic;
		replies = new ArrayList<>();
	}
	...
	{
		replies.sort(new PostDateComparator());
	}
	...
	public Post asPost()
	{
		...
		return new Post(id, author, content, rating, timeOfCreation);
	}
